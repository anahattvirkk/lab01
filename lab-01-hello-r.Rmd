...
The correlation between x and y for the circle dataset is -0.068, once again highlighting the importance of data visualization to uncover patterns that statistics alone might miss. This value is also almost identical to the r for dino. 
